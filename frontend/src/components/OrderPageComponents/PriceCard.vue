...
<template>
  <div class="card pl-[20px] pt-[15px] pr-[9px] mt-[12px] mb-[14px]">
    <p class="mb-[25px]">Ваш заказ</p>
...
<style scoped>
.card {
  @apply w-[444px] h-[155px] bg-[#FFF] rounded-[30px] shadow-[0px_0px_20px_0px_rgba(0,_0,-0,_0.10)];
}
</style>
